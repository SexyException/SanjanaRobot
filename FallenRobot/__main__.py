...
PM_START_TEXT = """
**ʜᴇʟʟᴏ* {}, 🥀
↬ ᴍʏ ɴᴀᴍᴇ ɪs {} , ᴀ ʙᴇsᴛ ᴛᴇʟᴇɢʀᴀᴍ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ʀᴏʙᴏᴛ. ɪ ᴄᴀɴ ʜᴇʟᴘ ᴜʜʜ ᴍᴀɴᴀɢᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴀɴᴅ ᴋᴇᴇᴘ ɪᴛ ʀᴜɴɴɪɴɢ sᴍᴏᴏᴛʜʟʏ. ᴛʏᴘᴇ /help ᴛᴏ ʟᴇᴀʀɴ ᴍᴏʀᴇ ᴀʙᴏᴜᴛ ᴡʜᴀᴛ ᴄᴀɴ ɪ ᴅᴏ.*
"""
...
buttons = [
    ...
    [
        ...
        InlineKeyboardButton(text="ᴄʜᴀᴛ ɢʀᴏᴜᴘ⚡️", url=f"https://t.me/ll_romance_house_ll"),
    ],
    [
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_sticker(
                "CAACAgUAAxkBAAEDj7dlcFC7_W7ELUPo5Q8jdrLH2XIGmgACeQYAAmifQVXZsBcvlqtQCTME"
            )
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        ...
                        InlineKeyboardButton(
                            text="ɢɪᴛʜᴜʙ",
                            url="https://github.com/SexyException",
                        ),
                    ],
                    [
